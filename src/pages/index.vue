  ...
  <div class="page-main">
    <div class="app-head flex-center">
      ...
      <div class="bottom-box">
        ...
        <div class="tabbar flex-center" :class="{'tabbar-active': item.active}" v-for="item in tab_store.tab_list" :key="item.index" @click="tab_store.clickTabbar(item.index)">
          <span>{{ item.label }}</span>
          <img class="hot-icon" v-if="item.hot" src="@/assets/img/hot.png" alt="">
        </div>
