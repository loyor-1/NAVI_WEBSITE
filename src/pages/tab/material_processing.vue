...
const menu = [
    { label: '全部', value: '全部', },
    { label: '电镜制样', value: '电镜制样' },
    { label: '材料加工', value: '材料加工' },
    { label: '加工成型', value: '加工成型' },
    { label: '热处理', value: '热处理' },
    { label: '切割成型', value: '切割成型' },
    { label: '真空封管', value: '真空封管' },
    { label: '球磨处理', value: '球磨处理' },
]
...
<template>
    <div class="page-main">
        <img class="head-pic" src="@/assets/img/cailiaojiagong.jpg" alt="">
