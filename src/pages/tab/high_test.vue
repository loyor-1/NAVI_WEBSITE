...
const menu = [
    { label: '全部', value: '全部', },
    { label: '球差TEM', value: '球差TEM' },
    { label: '同步辐射', value: '同步辐射' },
    { label: 'CT测试', value: 'CT测试' },
    { label: '配方破解', value: '配方破解' },
    { label: '失效分析', value: '失效分析' },
]
...
<template>
    <div class="page-main">
        <img class="head-pic" src="@/assets/img/highTest.jpg" alt="">
        <div class="equipment-box">
            <div class="flex-center font-large box-head">高端测试项目</div>
