...
const equipment_name = ref('')//临时存储检测设备名
...
//检测设备搜索
function inputEquipmentName() {
    params.value.equipmentName = equipment_name.value
}
...
async function changeStatus(value) {
    ...
    const new_params = JSON.parse(JSON.stringify(params.value))
    if(value > 0) {
    ...
    <div class="page-main flex-center">
        <div class="utils-box">
            <div class="search-box flex-center">
                ...
                <!-- 预约设备搜索 -->
                <el-input v-model="equipment_name" placeholder="请输入预约检测设备">
                    <template #append>
                        <el-button @click="inputEquipmentName">
                            <el-icon><Search /></el-icon>
                        </el-button>
                    </template>
                </el-input>
