...
function exportExperiment() {
    ...
    ElMessageBox.confirm(
        ...
        await download.getDownLoadXls('/file/communal/download/client/exportExperimentData/'+ order_info.value.orderId)
...
<template>
    <!-- 订单详情 -->
    <el-card class="container" v-loading="order_info_loading" shadow="never">
        <div style="overflow: auto; height: calc(100vh - 300px); padding: 10px;">
