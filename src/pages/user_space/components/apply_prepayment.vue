            ...
            <el-form class="form" ref="form" :rules="rules" :model="form_data" label-width="130px" label-position="left">
                ...
                <el-form-item prop="accountingInformationRules">
                    ...
                    <div style="display: flex; column-gap: 3%;">
                        ...
                        <el-input style="width: 300px;" v-show="accounting_information_list.includes('其他')" placeholder="请填写其他报账资料" v-model.trim="form_data.otherInformation"></el-input>
                    </div>
                </el-form-item>
    ...
    <el-dialog title="温馨提示" width="30%" center :show-close="false" :close-on-click-modal="false" v-model="apply_success_dialog">
        <el-result icon="success" title="申请成功">
            <template v-slot:extra>
                ...
                <h3>您也可在<span style="color:#E6A23C">我的发票</span>中查看开票进度</h3>
                <el-button @click="backAndRefresh" type="text" style="font-size: 16px;margin-left: 29px;margin-top: 10px"><i class="el-icon-arrow-left el-icon--left"></i>返回</el-button>
                <el-button @click="toMyInvoice()" type="text" style="font-size: 16px;margin-left: 29px;margin-top: 10px">查看我的发票<i class="el-icon-arrow-right el-icon--right"></i></el-button>
            </template>
        </el-result>
    </el-dialog>
</template>
